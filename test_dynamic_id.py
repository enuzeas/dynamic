...
실행: python test_dynamic_id.py
"""
from dynamic_id import calibrate_threshold, enroll, identify, verify


def main() -> None:
    id_a = enroll("A", ["A_1.mp4", "A_2.mp4"])
    id_b = enroll("B", ["B_1.mp4", "B_2.mp4"])
    registry = [id_a, id_b]
